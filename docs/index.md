...
| 20 | 023-handle-non-text-content-types.md | Handle non-text content types in parser | In Progress | TODO/ | Depends on 4, 7, 17. Highest-impact parser fix — 11K messages with lost content. |
